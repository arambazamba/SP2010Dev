...
public partial class HREntitiesDataContext : Microsoft.SharePoint.Linq.DataContext {
	
	#region Extensibility Method Definitions
	partial void OnCreated();
	#endregion
	
	public HREntitiesDataContext(string requestUrl) : 
			base(requestUrl) {
		this.OnCreated();
	}
	...
	/// External Candidates
	/// </summary>
	[Microsoft.SharePoint.Linq.ListAttribute(Name="Candidates")]
	public Microsoft.SharePoint.Linq.EntityList<CandidatesItem> Candidates {
		get {
			return this.GetList<CandidatesItem>("Candidates");
		}
	}
	
	[Microsoft.SharePoint.Linq.ListAttribute(Name="CurrentVacancies")]
	public Microsoft.SharePoint.Linq.EntityList<CurrentVacanciesItem> CurrentVacancies {
		get {
			return this.GetList<CurrentVacanciesItem>("CurrentVacancies");
		}
	}
	...
	/// <summary>
	/// Interviews for External Candidates
	/// </summary>
	[Microsoft.SharePoint.Linq.ListAttribute(Name="Interviews")]
	public Microsoft.SharePoint.Linq.EntityList<Item> Interviews {
		get {
			return this.GetList<Item>("Interviews");
		}
	}
	...
	/// Interview Outcomes
	/// </summary>
	[Microsoft.SharePoint.Linq.ListAttribute(Name="Outcomes")]
	public Microsoft.SharePoint.Linq.EntityList<Item> Outcomes {
		get {
			return this.GetList<Item>("Outcomes");
		}
	}
	
	/// <summary>
	/// Library for storing resumes from job applicants
	/// </summary>
	[Microsoft.SharePoint.Linq.ListAttribute(Name="Resumes")]
	public Microsoft.SharePoint.Linq.EntityList<ResumesDocument> Resumes {
		get {
			return this.GetList<ResumesDocument>("Resumes");
		}
	}
...
[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(CandidatesItem))]
[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(CurrentVacanciesItem))]
...
[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(ResumesDocument))]
...
[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(InterviewsTask))]
...
[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(InterviewsSummaryTask))]
...
/// Create a new list item.
/// </summary>
[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Item", Id="0x01", List="Candidates")]
public partial class CandidatesItem : Item {
	
	private string _homeCity;
	
	private Microsoft.SharePoint.Linq.EntitySet<ResumesDocument> _resumesDocument;
	...
	public CandidatesItem() {
		this._resumesDocument = new Microsoft.SharePoint.Linq.EntitySet<ResumesDocument>();
		this._resumesDocument.OnSync += new System.EventHandler<Microsoft.SharePoint.Linq.AssociationChangedEventArgs<ResumesDocument>>(this.OnResumesDocumentSync);
		this._resumesDocument.OnChanged += new System.EventHandler(this.OnResumesDocumentChanged);
		this._resumesDocument.OnChanging += new System.EventHandler(this.OnResumesDocumentChanging);
		this.OnCreated();
	}
	
	[Microsoft.SharePoint.Linq.ColumnAttribute(Name="HomeCity", Storage="_homeCity", FieldType="Text")]
	public string HomeCity {
		get {
			return this._homeCity;
		}
		set {
			if ((value != this._homeCity)) {
				this.OnPropertyChanging("HomeCity", this._homeCity);
	...
	[Microsoft.SharePoint.Linq.AssociationAttribute(Name="CandidateID", Storage="_resumesDocument", ReadOnly=true, MultivalueType=Microsoft.SharePoint.Linq.AssociationType.Backward, List="Resumes")]
	public Microsoft.SharePoint.Linq.EntitySet<ResumesDocument> ResumesDocument {
		get {
			return this._resumesDocument;
		}
		set {
			this._resumesDocument.Assign(value);
		}
	}
	
	private void OnResumesDocumentChanging(object sender, System.EventArgs e) {
		this.OnPropertyChanging("ResumesDocument", this._resumesDocument.Clone());
	}
	
	private void OnResumesDocumentChanged(object sender, System.EventArgs e) {
		this.OnPropertyChanged("ResumesDocument");
	}
	
	private void OnResumesDocumentSync(object sender, Microsoft.SharePoint.Linq.AssociationChangedEventArgs<ResumesDocument> e) {
		if ((Microsoft.SharePoint.Linq.AssociationChangedState.Added == e.State)) {
			e.Item.CandidateID = this;
		}
		else {
			e.Item.CandidateID = null;
		}
	}
}
...
/// Create a new list item.
/// </summary>
[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Item", Id="0x01", List="CurrentVacancies")]
public partial class CurrentVacanciesItem : Item {
	
	private string _location;
	
	private System.Nullable<int> _interviewerId;
	
	private string _interviewerImnName;
	...
	[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Interviewer", Storage="_interviewerId", FieldType="User", IsLookupId=true)]
	public System.Nullable<int> InterviewerId {
		get {
			return this._interviewerId;
		}
		set {
			if ((value != this._interviewerId)) {
				this.OnPropertyChanging("InterviewerId", this._interviewerId);
				this._interviewerId = value;
				this.OnPropertyChanged("InterviewerId");
			}
		}
	}
	
	[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Interviewer", Storage="_interviewerImnName", ReadOnly=true, FieldType="User", IsLookupValue=true)]
	public string InterviewerImnName {
		get {
			return this._interviewerImnName;
		}
		set {
			if ((value != this._interviewerImnName)) {
				this.OnPropertyChanging("InterviewerImnName", this._interviewerImnName);
				this._interviewerImnName = value;
				this.OnPropertyChanged("InterviewerImnName");
			}
		}
	}
}
...
/// Track a work item that you or your team needs to complete.
/// </summary>
[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Task", Id="0x0108", List="Interviews")]
public partial class InterviewsTask : Task {
	...
	[Microsoft.SharePoint.Linq.AssociationAttribute(Name="Predecessors", Storage="_predecessors", MultivalueType=Microsoft.SharePoint.Linq.AssociationType.Multi, List="Interviews")]
...
/// Create a new document.
/// </summary>
[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Document", Id="0x0101", List="Resumes")]
public partial class ResumesDocument : Document {
	
	private System.Nullable<bool> _active;
	
	private Microsoft.SharePoint.Linq.EntityRef<CandidatesItem> _candidateID;
	...
	public ResumesDocument() {
		this._candidateID = new Microsoft.SharePoint.Linq.EntityRef<CandidatesItem>();
		this._candidateID.OnSync += new System.EventHandler<Microsoft.SharePoint.Linq.AssociationChangedEventArgs<CandidatesItem>>(this.OnCandidateIDSync);
		this._candidateID.OnChanged += new System.EventHandler(this.OnCandidateIDChanged);
		this._candidateID.OnChanging += new System.EventHandler(this.OnCandidateIDChanging);
		this.OnCreated();
	}
	...
	[Microsoft.SharePoint.Linq.AssociationAttribute(Name="CandidateID", Storage="_candidateID", MultivalueType=Microsoft.SharePoint.Linq.AssociationType.Single, List="Candidates")]
	public CandidatesItem CandidateID {
		get {
			return this._candidateID.GetEntity();
		}
		set {
			this._candidateID.SetEntity(value);
		}
	}
	
	private void OnCandidateIDChanging(object sender, System.EventArgs e) {
		this.OnPropertyChanging("CandidateID", this._candidateID.Clone());
	}
	
	private void OnCandidateIDChanged(object sender, System.EventArgs e) {
		this.OnPropertyChanged("CandidateID");
	}
	
	private void OnCandidateIDSync(object sender, Microsoft.SharePoint.Linq.AssociationChangedEventArgs<CandidatesItem> e) {
		if ((Microsoft.SharePoint.Linq.AssociationChangedState.Added == e.State)) {
			e.Item.ResumesDocument.Add(this);
		}
		else {
			e.Item.ResumesDocument.Remove(this);
		}
	}
}
...
/// Group and describe related tasks that you or your team needs to complete.
/// </summary>
[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Summary Task", Id="0x012004", List="Interviews")]
public partial class InterviewsSummaryTask : SummaryTask {
