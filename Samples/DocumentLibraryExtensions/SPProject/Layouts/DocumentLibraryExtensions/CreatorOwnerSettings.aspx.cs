...
namespace Integrations.Layouts.DocumentLibraryExtensions
{
    public partial class CreatorOwnerSettings : LayoutsPageBase
    {
        ...
        protected void BindHandler(string ListName)
        {
            ...
            if (list!=null)
            {
                list.EventReceivers.Add(SPEventReceiverType.ItemAdded, Assembly.GetExecutingAssembly().FullName, "Integrations.DocumentLibraryExtensions.CreatorOwnerEventReceiver");                
            }
        }
    }
}
