...
public partial class SmartPortalDataContext : Microsoft.SharePoint.Linq.DataContext {
	...
	[Microsoft.SharePoint.Linq.ListAttribute(Name="Demo Dokumente")]
	public Microsoft.SharePoint.Linq.EntityList<DemoDokumenteDocument> DemoDokumente {
		get {
			return this.GetList<DemoDokumenteDocument>("Demo Dokumente");
		}
	}
	...
	[Microsoft.SharePoint.Linq.ListAttribute(Name="Favorites")]
	public Microsoft.SharePoint.Linq.EntityList<Link> Favorites {
		get {
			return this.GetList<Link>("Favorites");
		}
	}
	...
	[Microsoft.SharePoint.Linq.ListAttribute(Name="My Pictures")]
	public Microsoft.SharePoint.Linq.EntityList<MyPicturesPicture> MyPictures {
		get {
			return this.GetList<MyPicturesPicture>("My Pictures");
		}
	}
	
	[Microsoft.SharePoint.Linq.ListAttribute(Name="My Schedule")]
	public Microsoft.SharePoint.Linq.EntityList<MyScheduleEvent> MySchedule {
		get {
			return this.GetList<MyScheduleEvent>("My Schedule");
		}
	}
	
	[Microsoft.SharePoint.Linq.ListAttribute(Name="MyLib")]
	public Microsoft.SharePoint.Linq.EntityList<Document> MyLib {
		get {
			return this.GetList<Document>("MyLib");
		}
	}
	...
	[Microsoft.SharePoint.Linq.ListAttribute(Name="Produktion")]
	public Microsoft.SharePoint.Linq.EntityList<ProduktionItem> Produktion {
		get {
			return this.GetList<ProduktionItem>("Produktion");
		}
	}
	
	[Microsoft.SharePoint.Linq.ListAttribute(Name="Projekte")]
	public Microsoft.SharePoint.Linq.EntityList<Item> Projekte {
		get {
			return this.GetList<Item>("Projekte");
		}
	}
...
[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(ProduktionItem))]
...
[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(DemoDokumenteDocument))]
...
[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(MyScheduleEvent))]
...
[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(ProjekteTask))]
...
[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(MyPicturesPicture))]
...
[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(ProjekteSummaryTask))]
...
/// Create a new list item.
/// </summary>
[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Item", Id="0x01", List="Produktion")]
public partial class ProduktionItem : Item {
	...
	public ProduktionItem() {
		this.OnCreated();
	}
	
	[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Dauer", Storage="_dauer", FieldType="Number")]
	public System.Nullable<double> Dauer {
		...
		set {
			if ((value != this._dauer)) {
				this.OnPropertyChanging("Dauer", this._dauer);
				this._dauer = value;
...
public partial class CustomersContact : Contact {
	...
	private Microsoft.SharePoint.Linq.EntitySet<DemoDokumenteDocument> _demoDokumenteDocument;
	...
	public CustomersContact() {
		this._demoDokumenteDocument = new Microsoft.SharePoint.Linq.EntitySet<DemoDokumenteDocument>();
		this._demoDokumenteDocument.OnSync += new System.EventHandler<Microsoft.SharePoint.Linq.AssociationChangedEventArgs<DemoDokumenteDocument>>(this.OnDemoDokumenteDocumentSync);
		this._demoDokumenteDocument.OnChanged += new System.EventHandler(this.OnDemoDokumenteDocumentChanged);
		this._demoDokumenteDocument.OnChanging += new System.EventHandler(this.OnDemoDokumenteDocumentChanging);
		this.OnCreated();
	}
	...
	[Microsoft.SharePoint.Linq.AssociationAttribute(Name="Kunden", Storage="_demoDokumenteDocument", ReadOnly=true, MultivalueType=Microsoft.SharePoint.Linq.AssociationType.Backward, List="Demo Dokumente")]
	public Microsoft.SharePoint.Linq.EntitySet<DemoDokumenteDocument> DemoDokumenteDocument {
		get {
			return this._demoDokumenteDocument;
		}
		set {
			this._demoDokumenteDocument.Assign(value);
		}
	}
	
	private void OnDemoDokumenteDocumentChanging(object sender, System.EventArgs e) {
		this.OnPropertyChanging("DemoDokumenteDocument", this._demoDokumenteDocument.Clone());
	}
	
	private void OnDemoDokumenteDocumentChanged(object sender, System.EventArgs e) {
		this.OnPropertyChanged("DemoDokumenteDocument");
	}
	
	private void OnDemoDokumenteDocumentSync(object sender, Microsoft.SharePoint.Linq.AssociationChangedEventArgs<DemoDokumenteDocument> e) {
...
/// Create a new document.
/// </summary>
[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Document", Id="0x0101", List="Demo Dokumente")]
public partial class DemoDokumenteDocument : Document {
	
	private System.Nullable<Kundentyp> _kundentyp;
	
	private Microsoft.SharePoint.Linq.EntityRef<CustomersContact> _kunden;
	...
	public DemoDokumenteDocument() {
		this._kunden = new Microsoft.SharePoint.Linq.EntityRef<CustomersContact>();
		this._kunden.OnSync += new System.EventHandler<Microsoft.SharePoint.Linq.AssociationChangedEventArgs<CustomersContact>>(this.OnKundenSync);
		this._kunden.OnChanged += new System.EventHandler(this.OnKundenChanged);
		this._kunden.OnChanging += new System.EventHandler(this.OnKundenChanging);
		this.OnCreated();
	}
	
	[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Kundentyp", Storage="_kundentyp", Required=true, FieldType="Choice")]
	public System.Nullable<Kundentyp> Kundentyp {
		get {
			return this._kundentyp;
		}
		set {
			if ((value != this._kundentyp)) {
				this.OnPropertyChanging("Kundentyp", this._kundentyp);
				this._kundentyp = value;
				this.OnPropertyChanged("Kundentyp");
			}
		}
	}
	
	[Microsoft.SharePoint.Linq.AssociationAttribute(Name="Kunden", Storage="_kunden", MultivalueType=Microsoft.SharePoint.Linq.AssociationType.Single, List="Customers")]
	public CustomersContact Kunden {
		get {
			return this._kunden.GetEntity();
		}
		set {
			this._kunden.SetEntity(value);
		}
	}
	
	private void OnKundenChanging(object sender, System.EventArgs e) {
		this.OnPropertyChanging("Kunden", this._kunden.Clone());
	}
	
	private void OnKundenChanged(object sender, System.EventArgs e) {
		this.OnPropertyChanged("Kunden");
	}
	
	private void OnKundenSync(object sender, Microsoft.SharePoint.Linq.AssociationChangedEventArgs<CustomersContact> e) {
		if ((Microsoft.SharePoint.Linq.AssociationChangedState.Added == e.State)) {
			e.Item.DemoDokumenteDocument.Add(this);
		}
		else {
			e.Item.DemoDokumenteDocument.Remove(this);
		}
	}
}
...
/// Create a new meeting, deadline or other event.
/// </summary>
[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Event", Id="0x0102", List="My Schedule")]
public partial class MyScheduleEvent : Event {
...
/// Track a work item that you or your team needs to complete.
/// </summary>
[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Task", Id="0x0108", List="Projekte")]
public partial class ProjekteTask : Task {
	...
	[Microsoft.SharePoint.Linq.AssociationAttribute(Name="Predecessors", Storage="_predecessors", MultivalueType=Microsoft.SharePoint.Linq.AssociationType.Multi, List="Projekte")]
...
/// Upload an image or a photograph.
/// </summary>
[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Picture", Id="0x010102", List="My Pictures")]
public partial class MyPicturesPicture : Picture {
	...
	public MyPicturesPicture() {
		this.OnCreated();
	}
	
	[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Description", Storage="_comments", FieldType="Text")]
...
/// Group and describe related tasks that you or your team needs to complete.
/// </summary>
[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Summary Task", Id="0x012004", List="Projekte")]
public partial class ProjekteSummaryTask : SummaryTask {
...
public enum Kundentyp : int {
	
	None = 0,
	
	Invalid = 1,
	
	[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="Industrie")]
	Industrie = 2,
	
	[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="Einzelhandel")]
	Einzelhandel = 4,
}
